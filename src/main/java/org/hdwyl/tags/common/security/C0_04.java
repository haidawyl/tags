...
//		return null;
    ...
    {
        byte _$4[] = (_$3 instanceof String) ? ((String)_$3).getBytes() : (byte[])(byte[])_$3;
        int _$5 = _$4.length;
        if (_$5 > 0)
        {
            try
    ...
    public static String s07(Object ov, boolean tojm, int key, int ch1, int ch2)
    {
        ...
        return new String(tojm ? s02(s03(key, ch1, ch2, bs)) : s01(key, ch1, ch2, s00(bs)));
    }
